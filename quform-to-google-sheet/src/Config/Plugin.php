...
use QuformToGoogleSheet\Common\Traits\Singleton;
...
final class Plugin {
	...
	public function data(): array {
		$plugin_data = apply_filters( 'quform_to_google_sheet_plugin_data', [
			'settings'               => get_option( 'quform-to-google-sheet-settings' ),
			'plugin_path'            => untrailingslashit(
				plugin_dir_path( QUFORM_TO_GOOGLE_SHEET_PLUGIN_FILE )  // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
			),
			'plugin_template_folder' => 'templates',
			'ext_template_folder'    => 'quform-to-google-sheet-templates',
			/**
			 * Add extra data here
			 */
		] );
		return array_merge(
			apply_filters( 'quform_to_google_sheet_plugin_meta_data',
				get_file_data( QUFORM_TO_GOOGLE_SHEET_PLUGIN_FILE, // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
					[
						'name'         => 'Plugin Name',
						'uri'          => 'Plugin URI',
