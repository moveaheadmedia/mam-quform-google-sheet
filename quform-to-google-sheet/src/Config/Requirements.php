...
final class Requirements extends Base {
	...
	public function specifications(): array {
		return apply_filters( 'quform_to_google_sheet_plugin_requirements', [
		...
		foreach (
			[
				...
				[
					...
					'title'   => __( 'Invalid PHP version', 'quform-to-google-sheet' ),
					'message' => sprintf( /* translators: %1$1s: required php version, %2$2s: current php version */
						__( 'You must be using PHP %1$1s or greater. You are currently using PHP %2$2s.', 'quform-to-google-sheet' ),
				...
				[
					...
					'title'   => __( 'Invalid WordPress version', 'quform-to-google-sheet' ),
					'message' => sprintf( /* translators: %1$1s: required wordpress version, %2$2s: current wordpress version */
						__( 'You must be using WordPress %1$1s or greater. You are currently using WordPress %2$2s.', 'quform-to-google-sheet' ),
