...
namespace QuformToGoogleSheet\Integrations\Widget;
 ...
 * Class HTML_Widget
 *
 * @package QuformToGoogleSheet\Integrations\Widget
 */
class HTML_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = [
			...
			'description'                 => __( 'Displays HTML code with syntax highlighting.', 'quform-to-google-sheet' ),
			'customize_selective_refresh' => true,
		];
		$control_ops = [];
		parent::__construct( 'quform-to-google-sheet', __( 'HTML Test Widget', 'quform-to-google-sheet' ), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 * @since 0.1.0
		 */
		$content = apply_filters( 'quform_to_google_sheet_html_widget_content', $content, $instance, $this );
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'content' ) ); ?>" class="screen-reader-text"><?php esc_html_e( 'Content:', 'quform-to-google-sheet' ); ?></label>
